...
interface UsuarioDao {
    ...
    suspend fun inserir(entity: UsuarioEntity): Long

    @Update
    suspend fun atualizar(entity: UsuarioEntity)
    ...
    suspend fun buscarPorUserId(userId: String): UsuarioEntity?
     ...
     */
    @Query("UPDATE usuarios SET userId = :novoUserId WHERE id = :id")
